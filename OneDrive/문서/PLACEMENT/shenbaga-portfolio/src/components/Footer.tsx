    ...
    <footer className="border-t border-border bg-surface py-8">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="font-mono text-xs text-muted">
          <span className="text-accent">~/</span>shenbaga-portfolio · Built with Next.js + Tailwind
        </div>
        <div className="font-mono text-xs text-muted/50">
          © {new Date().getFullYear()} {personal.name}
        </div>
        <div className="flex items-center gap-4">
          <a href={personal.github} target="_blank" rel="noopener noreferrer" className="text-muted hover:text-accent transition-colors">
